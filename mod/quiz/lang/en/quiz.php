...
$string['questiondefaultsheading'] = 'Question defaults';
$string['questiondefaultssave'] = 'Enable saving question defaults';
$string['questiondefaultssave_desc'] = 'Saves the default settings in user preferences when creating a new question. (eg. Default mark, One or multiple answers, Shuffle the choices, Number the choices, Show standard instructions)';
$string['questiondefaultsreset'] = 'Resets all question defaults for all users';
$string['questiondefaultsreset_desc'] = 'Removes any question defaults that have been saved as user preferences for all users. Note: This setting will be reset after the user preferences are removed.';
